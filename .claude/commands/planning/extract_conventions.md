...
└── api-contracts.md    # API schemas, contracts, versioning
```
...
- [Suggested convention to establish]

Run `/plan` to create implementation plans that follow these conventions.
```
